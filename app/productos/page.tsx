...
import { getAllProducts } from "@/data/products" // ← Importamos desde el archivo central
import { useSearchParams } from "next/navigation"

export default function ProductsPage() {
  const allProducts = getAllProducts() // ← Obtenemos todos los productos
  ...
  useEffect(() => {
    // Si hay un parámetro categoria en la URL, lo aplicamos como filtro de género
  ...
  // Aplicar filtros automáticamente cuando cambie el filtro de género, categoría, marcas o sortBy
  useEffect(() => {
    applyFilters()
